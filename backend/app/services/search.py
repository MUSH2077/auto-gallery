...
from app.services.search_sql_filters import (
    ...
    _work_visibility_expressions,
    _work_has_tags_expression,
...
from app.services.search_pagination import (
    ...
    _encode_work_cursor,
    _meili_random_phase_filter,
    _meili_shuffle_key,
    _meili_shuffle_parts,
    _meili_tuple_comparison,
    _shuffle_ring_start,
    _sql_sort_spec,
)
...
class SearchService:
    ...
    _works_db_compatible = staticmethod(_works_db_compatible)

    _work_visibility_expressions = staticmethod(_work_visibility_expressions)

    _work_has_tags_expression = staticmethod(_work_has_tags_expression)

    _work_filter_conditions = staticmethod(_work_filter_conditions)
