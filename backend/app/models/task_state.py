...
ALLOWED_DOWNLOAD_TRANSITIONS: Final = {
    ...
    DOWNLOAD_DOWNLOADED:   {DOWNLOAD_IMPORTING, DOWNLOAD_PAUSED, DOWNLOAD_CANCELLED, DOWNLOAD_FAILED, DOWNLOAD_STALE},
    ...
    DOWNLOAD_FAILED:       {DOWNLOAD_ENQUEUED, DOWNLOAD_CANCELLED},
    DOWNLOAD_STALE:        {DOWNLOAD_ENQUEUED, DOWNLOAD_CANCELLED},
