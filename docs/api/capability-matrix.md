...
| Browse/search works, creators, tags, repositories, and subscriptions | `/api/v1/search`, `/api/v1/search/name-anchors`, `/api/v1/works`, `/api/v1/creators`, `/api/v1/tags`, `/api/v1/repositories`, `/api/v1/subscriptions` | — |
