...
type Tone = "success" | "danger" | "active" | "warning" | "muted";
...
export default function StatusBadge({
  ...
  const isActive = pulse ?? ["running", "downloading", "importing", "enqueued", "pending", "configuring", "post_download", "enqueuing_import", "import_indexing"].includes(s);
