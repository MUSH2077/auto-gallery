  ...
  const actions = [
    {
      ...
      desc: "Delete ALL data: works, assets, downloads, imports, creators, subscriptions. This is irreversible.",
      color: "red",
      mutation: clearAll,
    },
    {
      ...
      desc: "Delete all works, assets, and related records. Keeps creators and subscriptions intact.",
      color: "orange",
      mutation: clearWorks,
    },
    {
      ...
      desc: "Delete all creators, subscriptions, links, and source mappings. Keeps works intact.",
      color: "orange",
    ...
    },
    {
      ...
      desc: "Delete download and import job history. Keeps works, assets, and creators intact.",
      color: "yellow",
